...
def test_simple_episode_baseline():
    ...
    print("\nWhat this means:")
    print(f"- Episode 1: {episode_totals[0]:.0f} return, {episode_advantages[0]:+.0f} vs baseline")
    print(f"- Episode 2: {episode_totals[1]:.0f} return, {episode_advantages[1]:+.0f} vs baseline")
    print(f"- Episode 3: {episode_totals[2]:.0f} return, {episode_advantages[2]:+.0f} vs baseline")
    print(f"- Episode 4: {episode_totals[3]:.0f} return, {episode_advantages[3]:+.0f} vs baseline")
