from tests.common_patterns import (
    compute_gradient_step, print_gradient_info, print_metrics,
    extract_grad_norms, compute_activations, compute_activation_stats
)
...
def test_gradient_flow():
    ...
    print(f"Loss ratio (with/without): {grad_info_ln['loss']/grad_info_no_ln['loss']:.2f}x")
